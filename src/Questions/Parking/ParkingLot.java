...
import Questions.Parking.vehicle.Car;
import Questions.Parking.vehicle.MotorCycle;
import Questions.Parking.vehicle.Truck;
...
//    private ParkingRate parkingRate;
    ...
    public ParkingTicket getParkingTicket(Vehicle vehicle, int entranceGate) {
        ...
        if(parkingSpot == null){
            System.out.println("Questions.Parking lot is full :(");
            return null;
        }
